...
import { stagger, fadeInUp } from "../../components/Animation/FramerAnimation";
import {
  useColorModeValue,
  IconButton,
  Flex,
...
import {
  ...
  MotionList,
  MotionText,
} from "../../components/Animation/Motion/Motion";
import { IProject } from "../../data/projects";
interface IProjectLsyoutProps {
  project: IProject;
}
const ProjectLayoutMed: FC<IProjectLsyoutProps> = ({ project }) => {
  return (
    <Flex
            ...
            <Box width="full">
              ...
              {project.technologies && (
                <MotionList
                  ...
                  fontWeight="bold"
                >
                  {project.technologies.map((s, index) => (
...
const LeftProjectLayoutLarge: FC<IProjectLsyoutProps> = ({ project }) => {
  return (
...
const RightProjectLayoutLarge: FC<IProjectLsyoutProps> = ({ project }) => {
  return (
    <Flex width="full" display={["none", "none", "flex"]}>
      <MotionBox
        initial="initial"
